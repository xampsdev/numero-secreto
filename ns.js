...
function atualizarStatus() {
  ...
  if (historicoEl)
    historicoEl.textContent = historico.length ? historico.join(", ") : "—";
}
...
function atualizarSubtitulo() {
  ...
  if (badgeDificuldade) {
    ...
    badgeDificuldade.classList.remove(
      "badge-dificuldade--facil",
      "badge-dificuldade--medio",
      "badge-dificuldade--dificil",
      "badge-dificuldade--insano",
    );
    badgeDificuldade.classList.add(
      `badge-dificuldade--${dadosDificuldade.classe}`,
    );
  }
  if (dificuldadeSelect) {
    dificuldadeSelect.value = String(numeroMaximo);
    dificuldadeSelect.classList.remove(
      "dificuldade--facil",
      "dificuldade--medio",
      "dificuldade--dificil",
      "dificuldade--insano",
...
botao.addEventListener("click", function () {
  ...
  if (palpite === numeroSecreto) {
    ...
    if (palpite < numeroSecreto) {
      mensagem +=
        '<span class="dica-texto">Dica:</span> O número secreto é <span class="maiorMenor">maior</span> que o seu palpite.';
    } else {
      mensagem +=
        '<span class="dica-texto">Dica:</span> O número secreto é <span class="maiorMenor">menor</span> que o seu palpite.';
    }
